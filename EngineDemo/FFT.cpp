...
{
	return complex<float>(cos(XM_2PI*x / N), sin(XM_2PI*x / N));
}

void cFFT::fft(complex<float>* input, complex<float>* output, int stride, int offset)
{
